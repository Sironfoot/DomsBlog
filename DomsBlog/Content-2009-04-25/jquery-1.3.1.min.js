...
{
    $('.warningFade').css('background-color', '#fff');
    $('.warningFade')
        .animate({ backgroundColor: 'orange' }, 300)
        .animate({ backgroundColor: '#fff' }, 800);

    $('.errorFade').css('background-color', '#fff');
    $('.errorFade')
        .animate({ backgroundColor: 'red' }, 300)
        .animate({ backgroundColor: '#fff' }, 800);

    $('.successFade').css('background-color', '#fff');
    $('.successFade')
        .animate({ backgroundColor: 'green' }, 300)
        .animate({ backgroundColor: '#fff' }, 800);

    $('.qjBlueFade')
        .animate({ backgroundColor: '#3F9AF4' }, 300)
        .animate({ backgroundColor: '#E7EEF5' }, 900);

    $('.qjYellowFade')
        .animate({ backgroundColor: '#C4C100' }, 300)
        .animate({ backgroundColor: '#FFFFE0' }, 800);

    if (!$('input#EmailOnReply').attr('checked'))
    {
        var emailInput = $('#EmailAddress');
        var parent = emailInput.parents('div');

        emailInput.attr('disabled', 'disabled');
        parent.addClass('Disabled');
    }

    $('#EmailOnReply').click(function()
    {
        var emailInput = $('#EmailAddress');
        var parent = emailInput.parents('div');
